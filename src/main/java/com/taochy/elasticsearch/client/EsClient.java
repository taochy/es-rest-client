...
public class EsClient {
    ...
    public EsClient(String clusterName, String hostNames, int port) {
        log.info("hostNames = {}, port={}", clusterName, hostNames, port);
        this.hostNames = hostNames;
        this.port = port;
    }
...
//    }
     ...
     */
    public void prepareInsert(String indexName, String type, String docId, Map<String, Object> jsonMap) {
        try {
            UnifiedIndexRequest indexRequest = new UnifiedIndexRequest(this, indexName, type, docId);
...
//      indexRequest.opType(DocWriteRequest.OpType.CREATE);
     ...
     */
    public void prepareUpdate(String indexName, String type, String docId, Map<String, Object> jsonMap) {
        try {
            UnifiedUpdateRequest updateRequest = new UnifiedUpdateRequest(this, indexName, type, docId);
     ...
     */
    public DeleteResponse prepareDelete(String indexName, String type, String docId) {
        DeleteResponse deleteResponse = null;
        try {
            UnifiedDeleteRequest deleteRequest = new UnifiedDeleteRequest(this, indexName, type, docId);
    ...
    public GetResponse prepareGet(String indexName, String type, String docId) {
        ...
        try {
            UnifiedGetRequest getRequest = new UnifiedGetRequest(this, indexName, type, docId);
...
//    GetResponse documentFields = esClient.prepareGet("bangcle_app_20201021", "6045-00000000-0000-0000-0000-0000000006045|10000000000000011111000000000000018|1|com.demo.test");
...
//    esClient.deleteTemplate("template_bangcle_test");
...
//    esClient.prepareInsert("bangcle_app_20200716","4497-00000000-0000-0000-0000-0000000004497|10000000000000011111000000000000020|1|com.demo.test",jsonMap);
...
//    SearchResponse response = esClient.prepareSearch("bangcle_app_20201021").execute().actionGet();
//    System.out.println(response);
//    esClient.prepareGet("test","bangcle_type","1");
